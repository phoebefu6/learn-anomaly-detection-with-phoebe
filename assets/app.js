...
(function () {
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = mx
        ? ["a1-why-anomaly-detection.html", "a2-types-of-anomalies.html",
           "a3-methods-no-math.html", "a4-team-pipeline-rr.html",
           "a5-measuring-detection.html", "a6-strategy-pitfalls.html"]
        : ["b1-anomaly-foundations.html", "b2-statistical-detectors.html", "b3-rolling-seasonal.html",
           "b4-distance-density.html", "b5-isolation-forest.html",
           "b6-oneclass-covariance.html", "b7-timeseries-anomalies.html",
           "b8-deep-anomaly.html", "b9-evaluation.html", "b10-productionizing-alerting.html"];
